...
const FinalResult = () => {
  ...
  useEffect(() => {
    ...
    // 본인 정보 가져오기
    axios
      .get("http://ec2-52-78-9-158.ap-northeast-2.compute.amazonaws.com:8080/final/my", {
        headers: {
    ...
    // 친구 정보 가져오기
    axios
      .get("http://ec2-52-78-9-158.ap-northeast-2.compute.amazonaws.com:8080/final/friend", {
        headers: {
          Authorization: `Bearer ${token}`,
          codenum: `${friendnum}`,
        },
